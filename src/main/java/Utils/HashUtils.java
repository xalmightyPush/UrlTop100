...
public enum HashUtils {
    ...
    NATIVE_HASH,
    /**
     * CRC32_HASH as used by the perl API. This will be more consistent both across multiple API users as well as java
     * versions, but is mostly likely significantly slower.
     */
    CRC32_HASH,
    /**
     ...
     * 等HASH算法要快很多，这个算法的碰撞率很低. http://murmurhash.googlepages.com/
     */
    MurMurHash,
    /**
    ...
    public static void main(String[] args) {
        HashUtils alg = HashUtils.LUA_HASH;
        long h = 0;
